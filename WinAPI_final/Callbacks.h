...
extern libsgp4::DateTime timeStart;
extern libsgp4::DateTime timeEnd;
    ...
    case WM_COMMAND:
        if (HIWORD(wParam) == BN_CLICKED)
        {
            if (LOWORD(wParam) == IDC_SEARCH_BUTTON) {
                ...
                std::string search_directory = "Base_satellites\\";
            ...
            if (LOWORD(wParam) == IDC_MYBUTTON)
            {
                ...
                sim.add_orbit(name, line1, line2, timeStep, color_R, color_G, color_B, timeStart, timeEnd);
                sim.updateGraph3D(n);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_CREATE:
        ...
        hTextLine2 = CreateWindowW(L"STATIC", L"ENTER TLE Line 2",
            ...
            hPanel,
            NULL, hInst, NULL);
        hTextLine3 = CreateWindowW(L"STATIC", L"",
            WS_CHILD | WS_VISIBLE | SS_LEFT,
            1150, 55,
            200, 15,
            hPanel,
    ...
    case WM_MOUSEMOVE: {
        ...
        string VREMIA = sim.highlight(currentMousePos);
        if(VREMIA != "NULL")
